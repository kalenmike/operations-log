...
export function WeekReview({ week, onChange }: WeekReviewProps) {
  ...
  return (
    <div className="space-y-4">
      <TextInput
        label={t("review.weekSummary")}
        value={week.weekSummary}
        onChange={(v) => onChange({ ...week, weekSummary: v })}
        multiline
        rows={4}
        placeholder={t("review.weekSummaryPh")}
      />
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-2">
          ...
          <TextInput
            ...
            placeholder={t("review.thingOne")}
          />
          <TextInput
            label="2"
            value={week.energyGivers[1]}
            onChange={(v) => updateGiver(1, v)}
            placeholder={t("review.thingTwo")}
          />
        </div>
        <div className="space-y-2">
