                            ...
                            {weekDays.map((day, i) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`flex items-center gap-2 px-2 py-1.5 font-mono text-sm text-left border cursor-pointer transition-colors ${isActive
                                            ? "border-ink-800 bg-ink-800 text-parchment-100"
                                            : "border-parchment-200 bg-parchment-50 text-ink-600 hover:border-ink-400"
                                            }`}
                                    >
                                        <span
                                            className={`text-xs w-8 uppercase ${isActive
                                                ? "text-parchment-300"
                                                : isToday
